...
def display_loss(train_loss, val_loss, test_loss):
    epochs = range(1, len(train_loss) + 1)  # Assuming the length of all loss lists/arrays is the same
    ...
    plt.plot(epochs, test_loss, label='Test Loss', color='green', marker='s')
